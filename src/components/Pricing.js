    ...
    <div>
      ...
      <div className="max-w-[1024px] mx-auto py-12">
        <div className="text-center py-8 text-slate-300">
         ...
         <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corporis illo aspernatur, temporibus magnam veniam sunt,
             tempora, rerum eligendi suscipit incidunt eveniet error reprehenderit repellat ducimus quos corrupti sed minus ullam!</p>
        </div>

        <div className="grid md:grid-cols-2">
            <div className="bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative">
                <span className='px-3 uppercase bg-indigo-200 text-indigo-900 rounded-2xl text-sm'>Standard</span>
                <div >
            ...
            <div className="bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative">
                <span className='px-3 uppercase bg-indigo-200 text-indigo-900 rounded-2xl text-sm'>Premium</span>
                <div >
